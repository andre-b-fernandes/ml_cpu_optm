...
naive_cache_friendly_c:
	gcc --shared -fPIC -O0 -o naive_cache_friendly.so c/naive_cache_friendly.c
vectorized_c_macos:
...
all: naive_c naive_cache_friendly_c naive_loop_unrolling_c vectorized_c_macos vectorized_cache_friendly_loop_unrolling_c_macos
